...
describe "User admin page" do
  ...
  describe "edit/update" do
    ...
    let(:dotty_user) { FactoryGirl.create(:refinery_user, :username => 'user.name.with.lots.of.dots', :email => 'test@sample.com') }
  ...
  describe "destroy" do
    let!(:user) { FactoryGirl.create(:user, :username => "ugisozols", :email => 'test@sample.com') }
